...
;;;; Built-in
;;;;; basic coloring
   `(link ((t (:foreground ,zenburn-yellow :weight bold))))
   `(link-visited ((t (:foreground ,zenburn-yellow-2 :weight normal))))
...
;;;;; centaur-tabs
   `(centaur-tabs-default ((t (:background ,zenburn-bg :foreground ,zenburn-fg ))))
   `(centaur-tabs-selected ((t (:background ,zenburn-bg :foreground ,zenburn-fg+2 ))))
...
;;;;; doom-modeline
   `(doom-modeline-bar  ((t (:background ,zenburn-green))))
   `(doom-modeline-inactive-bar  ((t (:background ,zenburn-red))))
;;;;; ediff
